...
public class UpdateCustomerNameAvroEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3325192679648559534L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UpdateCustomerNameAvroEvent\",\"namespace\":\"com.zhigalko.core.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"string\"},{\"name\":\"eventType\",\"type\":\"string\"},{\"name\":\"aggregateId\",\"type\":\"long\"}]}");
   ...
   */
  public static com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder newBuilder() {
    return new com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder();
  }
   ...
   * @return A new UpdateCustomerNameAvroEvent RecordBuilder
   */
  public static com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder newBuilder(com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder other) {
    if (other == null) {
      return new com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder();
    } else {
      return new com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder(other);
    }
  }
   ...
   * @return A new UpdateCustomerNameAvroEvent RecordBuilder
   */
  public static com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder newBuilder(com.zhigalko.core.schema.UpdateCustomerNameAvroEvent other) {
    if (other == null) {
      return new com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder();
    } else {
      return new com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UpdateCustomerNameAvroEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.zhigalko.core.schema.UpdateCustomerNameAvroEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder setTimestamp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder setEventType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder clearEventType() {
      eventType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder setAggregateId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.zhigalko.core.schema.UpdateCustomerNameAvroEvent.Builder clearAggregateId() {
